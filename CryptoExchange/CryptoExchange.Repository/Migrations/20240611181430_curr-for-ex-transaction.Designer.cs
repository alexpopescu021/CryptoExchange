...
namespace CryptoExchange.Repository.Migrations
{
    ...
    [Migration("20240611181430_curr-for-ex-transaction")]
    partial class currforextransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CryptoExchange.Domain.Models.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TargetCurrencyId = 2,
                            TargetPrice = 40m,
                            TransactionDate = new DateTime(2024, 6, 11, 18, 14, 30, 821, DateTimeKind.Utc).AddTicks(9151),
                            UserId = 1
                        });
                });
