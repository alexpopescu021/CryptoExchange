...
namespace CryptoExchange.Repository.Migrations
{
    ...
    [Migration("20240602180822_exclude-entity-for-id")]
    partial class excludeentityforid
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CryptoExchange.Domain.Models.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TargetCurrencyId = 2,
                            TargetPrice = 40m,
                            TransactionDate = new DateTime(2024, 6, 2, 18, 8, 22, 742, DateTimeKind.Utc).AddTicks(7845),
                            UserId = 1
                        });
                });
