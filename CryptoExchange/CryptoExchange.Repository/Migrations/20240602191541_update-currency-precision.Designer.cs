...
namespace CryptoExchange.Repository.Migrations
{
    ...
    [Migration("20240602191541_update-currency-precision")]
    partial class updatecurrencyprecision
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CryptoExchange.Domain.Models.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TargetCurrencyId = 2,
                            TargetPrice = 40m,
                            TransactionDate = new DateTime(2024, 6, 2, 19, 15, 41, 98, DateTimeKind.Utc).AddTicks(3117),
                            UserId = 1
                        });
                });
