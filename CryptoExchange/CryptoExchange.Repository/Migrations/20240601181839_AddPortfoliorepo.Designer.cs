...
namespace CryptoExchange.Repository.Migrations
{
    ...
    [Migration("20240601181839_AddPortfoliorepo")]
    partial class AddPortfoliorepo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CryptoExchange.Domain.Models.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TargetCurrencyId = 2,
                            TargetPrice = 40m,
                            TransactionDate = new DateTime(2024, 6, 1, 18, 18, 39, 592, DateTimeKind.Utc).AddTicks(1569),
                            UserId = 1
                        });
                });
